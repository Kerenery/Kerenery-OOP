...
namespace Banks.SnapShot
{
    public class Caretaker
    {
        ...
        public void Backup()
        {
            ...
            using StreamWriter file = File.CreateText(@$"C:\Users\djhit\RiderProjects\Kerenery\Banks\Snapshots\{_mementos.Count}.json");
        ...
        public void Undo()
        {
            ...
            using StreamReader reader =
                new (@$"C:\Users\djhit\RiderProjects\Kerenery\Banks\Snapshots\{_mementos.Count}.json");
