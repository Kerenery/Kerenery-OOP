...
{
    public class CreateDepositAccountCommand : Command<CreateDepositAccountCommand.CreateDepositAccountSettings>
    {
        public override int Execute(CommandContext context, CreateDepositAccountSettings settings)
        {
            ...
            AnsiConsole.MarkupLine($"[bold green]Deposit account [/] is added successfully!");
            return 0;
        }

        public class CreateDepositAccountSettings : CommandSettings
        {
